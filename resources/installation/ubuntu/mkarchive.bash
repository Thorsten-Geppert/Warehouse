...
if [ $# != 2 ]
then
	echo "Usage: ${0} version name (e.g. ${0} 1.2.3 Ubuntu_1804LTS_amd64 (CentOS7_amd64))"
	exit 2
fi
...
VERSION="${1}"
BINARY_PATH="GuGIT-Warehouse-${VERSION}_${2}"
...
cp ../../../src/modules/admin/resources/languages/de/* "${BINARY_PATH}/resources/languages/de/"
